...
<head>
  <title>Website &mdash; Lelang Kendaraan</title>
  <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 site-navbar-target" role="banner">
      ...
      <!-- <div class="hero-slide owl-carousel site-blocks-cover"> -->
        <div class="intro-section" style="background-image: url('https://yooreka.id/assets/uploads/2018/08/20170904134621_Jobplanet__Tren_Perusahaan_Rekrut_Pekerja_Magang_Terus_Tumbuh-768x512.png');">
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-md-7 mx-auto text-center" data-aos="fade-up">
                <h1> Selamat Datang Website lelang Kendaraan!</h1>
                <p>Website Pelelangan zulfan.</p>
              ...
              <div class="col-12">
                <div class="copyright">
                  <p>
                    ...
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href= target="_blank" >By Zikry</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                  </p>
                </div>
              </div>
