                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="btn-group">
                                ...
                                <?php } ?>
                                    <a href="user/act.php?act=hapus&&id=<?=$list['id']?>" class="btn btn-sm btn-danger">Hapus</a>
                                    <a href="main.php?page=user&&method=edit&&id=<?=$list['id']?>" class="btn btn-sm btn-primary">Edit</a>
                            </div>
                        </td>
                    </tr>  
                    <?php
